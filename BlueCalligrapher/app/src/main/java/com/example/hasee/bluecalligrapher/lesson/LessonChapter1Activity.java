...
public class LessonChapter1Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lesson_chapter1);
        init();
    }
    private void init(){
    ...
    private void initTextStyle(){
        ...
        ((TextView)findViewById(R.id.title_chapter1_1)).setTypeface(typeface);
        ((TextView)findViewById(R.id.title_chapter1_2)).setTypeface(typeface);
        ((TextView)findViewById(R.id.title_chapter1_3)).setTypeface(typeface);
        ((TextView)findViewById(R.id.content_chapter1_1)).setTypeface(typeface);
        ((TextView)findViewById(R.id.content_chapter1_2)).setTypeface(typeface);
        ((TextView)findViewById(R.id.content_chapter1_3)).setTypeface(typeface);
