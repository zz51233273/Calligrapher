...
public class LessonChapter3Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lesson_chapter3);
        init();
    }
    private void init(){
    ...
    private void initTextStyle(){
        ...
        ((TextView)findViewById(R.id.title_chapter3_2)).setTypeface(typeface);
        ((TextView)findViewById(R.id.title_chapter3_3)).setTypeface(typeface);
        ((TextView)findViewById(R.id.title_chapter3_4_1)).setTypeface(typeface);
        ((TextView)findViewById(R.id.content_chapter3_4)).setTypeface(typeface);
