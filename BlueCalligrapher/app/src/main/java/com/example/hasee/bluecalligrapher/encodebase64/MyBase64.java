...
public class MyBase64 extends MyBaseNCodec {
    ...
    public MyBase64(boolean urlSafe) {
        this(76, CHUNK_SEPARATOR, urlSafe);
    }

    public MyBase64(int lineLength) {
        this(lineLength, CHUNK_SEPARATOR);
    }

    public MyBase64(int lineLength, byte[] lineSeparator) {
    ...
    public MyBase64(int lineLength, byte[] lineSeparator, boolean urlSafe) {
        ...
        if(lineSeparator != null) {
            if(this.containsAlphabetOrPad(lineSeparator)) {
                String sep = MyStringUtils.newStringUtf8(lineSeparator);
    ...
    public static boolean isBase64(String base64) {
        return isBase64(MyStringUtils.getBytesUtf8(base64));
    }
    ...
    public static String encodeBase64String(byte[] binaryData) {
        return MyStringUtils.newStringUsAscii(encodeBase64(binaryData, false));
    }
    ...
    public static String encodeBase64URLSafeString(byte[] binaryData) {
        return MyStringUtils.newStringUsAscii(encodeBase64(binaryData, false, true));
    }
    ...
    public static byte[] encodeBase64(byte[] binaryData, boolean isChunked, boolean urlSafe, int maxResultSize) {
        if(binaryData != null && binaryData.length != 0) {
            MyBase64 b64 = isChunked?new MyBase64(urlSafe):new MyBase64(0, CHUNK_SEPARATOR, urlSafe);
